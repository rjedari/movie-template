  ...
  >
    <div class="flex-col flex items-center justify-center">
      <div class="flex flex-col max-xs:max-w-xs">
        <div class="text-white text-3xl flex justify-center py-10">
          MOST POPULAR
        </div>
      ...
      <div
        class="flex overflow-y-hidden overflow-x-auto max-w-6xl bg-black max-xl:max-w-xl max-lg:max-w-lg max-md:w-fit max-md:max-w-md max-sm:max-w-screen-xxs"
      >
